...
namespace CrazyMinnow.SALSA.Daz
{
	...
	[AddComponentMenu("Crazy Minnow Studio/Daz3D/CM_DazSync")]
	public class CM_DazSync : MonoBehaviour 
	{
		...
		public void SetCharacterType(DazType characterType)
		{
			if (prevType != characterType)
			{
				...
				switch (dazType)
				{
					case CM_DazSync.DazType.Dragon:
						SetDragonSmall();
						SetDragonMedium();
						SetDragonLarge();
						break;
					case CM_DazSync.DazType.Emotiguy:
						SetEmotiguySmall();
						SetEmotiguyMedium();
						SetEmotiguyLarge();
						break;
					case CM_DazSync.DazType.Genesis_Genesis2:
						SetGenesis1_2Small();
						SetGenesis1_2Medium();
						SetGenesis1_2Large();
						break;
					case CM_DazSync.DazType.Genesis3:
						SetGenesis3Small();
						SetGenesis3Medium();
						SetGenesis3Large();
						break;
